...
<section class="section section--white" data-rv>
  <!-- Paint servers for the four capability icons. A stroked SVG cannot take a
       CSS gradient through its colour, so each stroke points at one of
       these instead. Zero-size and hidden: it renders nothing itself. -->
  <svg class="cap__defs" aria-hidden="true" focusable="false" width="0" height="0">
    <defs>
      ...
      <linearGradient id="capC" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stop-color="#B36436"/><stop offset="1" stop-color="#D2974C"/>
      </linearGradient>
      <linearGradient id="capD" x1="0" y1="0" x2="1" y2="1">
